...
**Your Answers here:**
<br>
1. dataSet1.R - Line 8: mytickers = c("SPY", "AAPL")
<br>
2. Cumulative returns: round(100*sum(StockReturns[,2]),1) = 380.7%
<br>
Average daily returns: round(100*mean(StockReturns[,2]),3) = 0.137%
<br>
St. dev. of daily returns: round(100*sd(StockReturns[,2]),3) = 2.189%
<br>
<hr>
<hr>
...
**Your Answers here:**
<br>
1. ncol(transposedData) = 2778
<br>
nrow(transposedData) = 2
<br>
2. 
```{r echo=FALSE, comment=NA, warning=FALSE, message=FALSE,results='asis',fig.align='center', fig=TRUE}
transposedData = t(StockReturns)
portfoliotrans = apply(transposedData,2,mean)
names(portfoliotrans) = colnames(transposedData)
pnl_plot(portfoliotrans)
```
...
**Your Answers here:**
<br>
1. dataSet1.R - line 9: startDate = "2001-01-01"
<br>
<br>
<br>
